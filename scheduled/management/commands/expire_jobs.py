...
def do():
    print("Running two weeks notice...")
    two_weeks = timedelta(weeks = 2)
    warns = models.EmpDocMain.objects.filter(start_date=date.today()+two_weeks)
    for w in warns:
    ...
    print("notices sent")
    print("deleting expired postings...")
    ...
    dels.delete()
    print("expired postings deleted")
    print("exiting...")
